const translations = {
  ...
  '输入文字消息': 'Type a text message',
  '输入消息…': 'Type a message…',
  '发送': 'Send',
  '正在连接，连接后可发送文字': 'Connecting… You can send text once connected',
  '正在发送文字': 'Sending message',
  '正在等待回复': 'Waiting for a response',
  '无法获取语音输出，请重试': 'Could not acquire voice output. Please try again.',
  '其他入口正在使用语音，请稍后重试': 'Another client is using voice. Please try again later.',
