const translations = {
  ...
  '拍照': 'Take photo',
  '相机预览': 'Camera preview',
  '相机已启用：仅在你选择拍照或提问时发送画面': 'Camera enabled: frames are sent only when you capture or ask a question',
  '相机连接已断开': 'The camera connection was disconnected',
  '页面已隐藏，相机已关闭': 'The page was hidden, so the camera was closed',
  ...
  '拍一张并回答我的问题': 'Take a photo and answer my question',
  '正在准备拍照提问': 'Preparing a photo question',
  '正在拍照并回答问题': 'Taking a photo and answering the question',
  '请先输入要回答的问题': 'Enter the question you want answered first',
  '当前模型不支持相机提问': 'The current model does not support camera questions',
  '切换后的模型不支持相机提问': 'The selected model does not support camera questions',
