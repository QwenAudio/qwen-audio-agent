...
if (isMain) {
  ...
  const required = [
    ...
    'examples/voicemem-memory/README.md',
    'examples/voicemem-memory/README_ZH.md',
    'examples/voicemem-memory/.env.example',
    'examples/voicemem-memory/gateway.mjs',
    'examples/voicemem-memory/voicemem-memory-provider.mjs',
    'examples/voicemem-memory/sidecar/server.py',
    'examples/voicemem-memory/sidecar/requirements.txt',
    'CONTRIBUTING.md',
