...
| `realtime.gateway-remote-access-v1-models` | Provider-neutral endpoint descriptors, connection profiles, and invitations keep publication topology and credentials outside GCP | `test/gateway-remote-access.test.mjs` |
