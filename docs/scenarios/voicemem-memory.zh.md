...
- 在语音 Session 结束后观察对话，并在后台整理用户语音的转写文本。
...
当前示例向 VoiceMem 发送用户语音的转写文本，不发送原始麦克风音频流。
...
[完整配置说明](https://github.com/QwenAudio/qwen-audio-agent/tree/main/examples/voicemem-memory)。
