const translations = {
  ...
  '模型 {model} 不支持音色 {voice}': 'Model {model} does not support voice {voice}',
  '可选音色：{voices}': 'Available voices: {voices}',
  '也可使用该模型生成的复刻音色 ID': 'You can also use a cloned voice ID generated for this model',
  '复刻音色 ID 前缀：{prefixes}': 'Cloned voice ID prefixes: {prefixes}',
  '不支持的 Realtime 模型：{model}': 'Unsupported Realtime model: {model}',
  '可选模型：{models}': 'Available models: {models}',
