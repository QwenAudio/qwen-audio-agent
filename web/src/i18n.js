const translations = {
  ...
  '后台观察中：最近 {count}/8 帧': 'Background observation: latest {count}/8 frames',
  '后台视觉分析不可用': 'Background vision analysis is unavailable',
  '深度分析当前画面': 'Deep-analyze the current view',
  '深度分析': 'Deep analysis',
  '后台分析中': 'Analyzing in background',
  '视觉分析完成': 'Visual analysis completed',
  '视觉分析结果': 'Visual analysis results',
  '后台视觉': 'Backend vision',
  '后台视觉分析': 'Backend visual analysis',
  '识别对象': 'Detected objects',
  '变化': 'Changes',
  '不确定项': 'Uncertainties',
  '来源帧': 'Source frames',
  '置信度': 'Confidence',
